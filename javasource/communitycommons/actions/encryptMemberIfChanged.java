 ...
 */
public class encryptMemberIfChanged extends UserAction<Boolean>
{
	...
	public encryptMemberIfChanged(IMendixObject item, String attributeName, String key, Boolean refreshItem)
	{
		super();
		this.item = item;
