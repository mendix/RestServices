 ...
 */
public class GenerateThumbnail extends UserAction<Boolean>
{
	...
	public GenerateThumbnail(IMendixObject sourceObj, Long thumbnailWidth, Long thumbnailHeight)
	{
		super();
	...
	public Boolean executeAction() throws Exception
	{
		...
		File basefilename = Core.getFileDocumentContentAsFile(getContext(), __sourceObj);
		String thumbfile = basefilename.getPath().replaceFirst(Pattern.quote(File.separator + "files" + File.separator), Matcher.quoteReplacement(File.separator + "files" + File.separator + "thumbs" + File.separator));
