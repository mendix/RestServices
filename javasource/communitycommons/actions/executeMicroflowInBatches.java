 ...
 */
public class executeMicroflowInBatches extends UserAction<Boolean>
{
	...
	public executeMicroflowInBatches(String xpath, String microflow, Long batchsize, Boolean waitUntilFinished, Boolean ascending)
	{
		super();
		this.xpath = xpath;
