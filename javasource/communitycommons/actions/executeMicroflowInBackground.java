 ...
 */
public class executeMicroflowInBackground extends UserAction<Boolean>
{
	private String microflowName;
	private IMendixObject contextObject;

	public executeMicroflowInBackground(String microflowName, IMendixObject contextObject)
	{
		super();
