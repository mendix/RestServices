 ...
 * 
 */
public class request extends UserAction<IMendixObject>
{
	...
	public request(String method, String url, IMendixObject optRequestData, IMendixObject optResponseData, Boolean sendWithFormEncoding)
	{
		super();
